...
class PrescriptionsRecyclerAdapter:RecyclerView.Adapter<PrescriptionsRecyclerAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            itemView.setOnClickListener {
                ...
                val intent = Intent(context, PrescriptionsFragment::class.java).apply {
